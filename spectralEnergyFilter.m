function energyFilter=spectralEnergyFilter(xregion, yregion, d, q)
...
%initialize indices
[k1, k2]=meshgrid(-pi : 2*pi/yregion : pi-2*pi/yregion, -pi : 2*pi/xregion : pi-2*pi/xregion);
